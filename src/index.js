...
root.render(
  ...
  <form class="sign--form" autocomplete="off" method="post">
      <div class="form-element">
          ...
          <label class="form-element--lable" for="username_input">Username or Customer #</label>
          <span class="form-element--error-message">Invalid email</span>
      </div>
      {/* <my-input class="ctag">hey</my-input> */}

      <div class="form-element">
          <input id="password_input" class="form-element--input"  type="password" name="password" required />
          <label class="form-element--lable" for="password_input"> password</label>
      ...
      <div class="button">
          ...
          <button type="submit" class="signin__button">Sign In without password</button>
      </div>
  </form>
  <div class="footer">
      <p class="footer--description">or sign in with</p>
      ...
      <p class="footer--description">Need to find <a href="">your username</a> or <a href=""> your password</a>?</p>
  </div>
